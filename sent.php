...
// one email only
$url = 'https://sendgrid.com/api/mail.send.json?api_user=jefffis&api_key=X3saim&to=' . $email_1 . '&toname=' . $email_1 . '&subject=' . $message_type_subject . '&text=' . $message_type_num . '&from=' . $email_4;

// two emails only
$url2 = 'https://sendgrid.com/api/mail.send.json?api_user=jefffis&api_key=X3saim&to=' . $email_1 . '&toname=' . $email_1 . '&to=' . $email_2 . '&toname=' . $email_2 . '&subject=' . $message_type_subject . '&text=' . $message_type_num . '&from=' . $email_4;

// three emails
$url3 = 'https://sendgrid.com/api/mail.send.json?api_user=jefffis&api_key=X3saim&to=' . $email_1 . '&toname=' . $email_1 . '&to=' . $email_2 . '&toname=' . $email_2 . '&to=' . $email_3 . '&toname=' . $email_3 . '&subject=' . $message_type_subject . '&text=' . $message_type_num . '&from=' . $email_4;
